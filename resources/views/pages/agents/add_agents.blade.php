                                    ...
                                    <div class="modal-body">
                                            ...
                                            <div class="col-md-9">
                                                <div class="row">
                                                    ...
                                                    <h4 class=" col-md-4">Surname:&nbsp;</h4><span
                                                        class="col-md-8 text-primary h4" id="display_surname"></span>

                                                    <h4 class=" col-md-4">Gender:&nbsp;</h4><span
                                                        class="col-md-8 text-primary h4" id="display_gender"></span>
                                                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <h4 class=" col-md-4">Phone Number 1:&nbsp;</h4><span
                                                class="col-md-8 text-primary h4" id="display_phone_number_1"></span>

                                            <h4 class=" col-md-4">Phone Number 2:&nbsp;</h4><span
                                                class="col-md-8 text-primary h4" id="display_phone_number_2"></span>

                                            <h4 class=" col-md-4">Educational Level:&nbsp;</h4>
                                            <span class="col-md-8 text-primary h4" id="display_educational_level"></span>

                                            <h4 class=" col-md-4">Institution Name:&nbsp;</h4><span
                                                class="col-md-8 text-primary h4" id="display_institution_name"></span>
                                            ...
                                            <h4 class=" col-md-4">Agent Region:&nbsp;</h4><span
                                                class="col-md-8 text-primary h4" id="display_agent_region"></span>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <button type="button"
                                                            ...
                                                            id="confirm_agent"><i
                                                                class="mdi mdi-check-all mr-2"></i>Confirm</button>
                                                    </div>
                                                    <div class="col-md-2"></div>
                                                </div>
                                            </div>
